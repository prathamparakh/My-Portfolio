...
import ProjectsSection from './ProjectsSection'; // Import at the top level
...
const Portfolio = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-8 md:mb-0">
              <div className="bg-gray-300 h-64 w-64 mx-auto rounded-full overflow-hidden">
                ...
                <img src="/assets/image/photo.jpeg" alt="Profile" className="h-full w-full object-cover" />
              </div>
            </div>
      ...
      {/* Projects Section - Using the imported component */}
      <ProjectsSection />
